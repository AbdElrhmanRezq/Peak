...
class CustomExercisesGrid extends StatelessWidget {
  final List<ExerciseModel> exercises;
  const CustomExercisesGrid({required this.exercises, super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: exercises[index].difficulty == 'intermediate'
                        ? Colors.amberAccent
